...
individuals_exemple = [
    # name, cd_nom, additional_data
    ("indi_1", 79273, {"collier": "A123", "taille_cm": 35}),
    ("indi_2", 79273, {"collier": "B456", "taille_cm": 40}),
    ("indi_3", 649883, {"collier": "C789", "taille_cm": 50}),
    ("indi_4", 97947, {"collier": "D012", "taille_cm": 60}),
    ("indi_5", 3493, {"collier": "E345", "taille_cm": 70}),
]
...
def data_individuals(users):
    ...
    for name, cd_nom, additional_data in individuals_exemple:
